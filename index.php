                        ...
                        <div class="tab_contents" id="student_contents">
                            <div class="description">
                                <form method="POST" action="tourokukari.php">
                                    <!-- disabledにしているものは既に登録しているデータを引っ張ってくる想定 -->                                    <p><p>名前:<input type="text" name="name" value="<?php echo $row['Name']; ?>" ></p>
									...
									<p>メールアドレス2: <input type="email" name="email" value="<?php echo $row['address']; ?>" ></p>
                        ...
                        <div class="tab_contents" id="society_contents">
                            <div class="description">
                                <form method="POST" action="tourokukari.php">-->
                                    ...
                                    <!--<p>名前:<input type="text" name="name" value="瀬戸口 洋子" disabled></p>
                                    <p>生年月日:<input type="date" name="date">
                                    or <input type="date" name="date" value="1993-02-14" disabled></p>
                                    <p>性別:<select name="sex"><option value="">-</option><option value="man">男</option><option value="woman">女</option></select>
                                    or <input type="text" name="sex" value="女" disabled></p>
                                    <p>電話番号:<input type="tel" name="tel" value="077-521-4129" disabled></p>
                                    <p>メールアドレス: <input type="email" name="email" value="yoko_seto11@gmail.com" disabled></p>
                                    <p>職歴1: <input type="text" name="career1" value="グーグル株式会社" disabled></p>
                                    <p>職歴2: <input type="text" name="career2" value="" disabled></p>
                                    <p>職歴3: <input type="text" name="career3" value="" disabled></p>-->
                                    <!-- プロフィール写真は略 -->
                                    <!--<p class="desc">欲しい機能にチェックを入れて追加してください。</p>
                                    <div class="sel_opts">
